    ...
    <main className="min-h-screen overflow-hidden bg-[#08070d] text-white">
      <nav className="container flex items-center justify-between py-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[10px] uppercase tracking-[0.28em] text-slate-500">Academic intelligence layer</p>
          </div>
        </div>
      ...
      <section className="container relative grid gap-12 pb-24 pt-14 lg:grid-cols-[1.1fr_.9fr] lg:items-center lg:pt-24">
        ...
        <div className="relative z-10">
          <div className="mb-6 flex items-center gap-3"><span className="eyebrow">Cairo branch / medicine cohort</span><span className="h-px w-16 bg-pink-400/60" /></div>
      ...
      <footer id="signal" className="container flex flex-col gap-4 border-t border-white/10 py-8 text-xs text-slate-500 sm:flex-row sm:items-center sm:justify-between"><p className="tracking-[0.15em]">SPBU//FANTASY — UNIVERSITY PERFORMANCE LEAGUE</p><p>Built for insight, not surveillance.</p></footer>
    </main>
  );
}
