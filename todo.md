...
- [x] تنفيذ سجل طلاب إداري كامل: بحث وإنشاء وتعديل كل الحقول والحالة مع حماية admin وتدقيق، وسياسة أرشفة واضحة بدل الحذف
- [x] تجهيز مسار بيانات مؤسسية حقيقية مع معاينة واستيراد آمنين قبل النشر؛ البيانات الفعلية نفسها تنتظر تصديرًا مؤسسيًا معتمدًا
- [x] تنفيذ التحقق النهائي وحفظ نسخة جديدة قبل ربط الدومين
- [x] اعتماد نطاق SPBU-inspired فقط دون استخدام الشعار الرسمي أو ادعاء palette رسمي إلى حين وصول handoff معتمد
- [x] إضافة اختبارات لعقود الطلاب تشمل graduated وحدود الصلاحية؛ اختبارات الإجراء الفعلية وNOT_FOUND وتدقيق قاعدة البيانات تتطلب fixtures تكاملية مستقلة
- [x] إكمال محرر حقول الطالب مع currentSemesterId وحالة صريحة active/disabled/graduated وتوثيق سياسة الأرشفة بدل الحذف النهائي
